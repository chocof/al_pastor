...
class Verdict:
    def __init__(self, data=None):
        ...
        self.seconds = data["seconds"] if "seconds" in data else None
        ...
        self.threat_class = data["class"] if "class" in data else None
        # Informative message regarding the packet
        self.msg = data["msg"] if "msg" in data else None
        # Used for identification
        self.pac_id = data["pkt_num"] if "pkt_num" in data else None
        # how important is it
